...
class TabGroup extends EventEmitter {
  ...
  addTab (args = this.options.newTab) {
    ...
    if (args.active === true) {
    //   await tab.setBrowserView(args.src) 
      tab.activate();
    }
...
class Tab extends EventEmitter {
   constructor (tabGroup, id, args) {
    ...
    this.tabElements = {};
    this.browserView =  createNewBrowserView(args.src);
...
//   async setBrowserView(src){
//     if (this.isClosed) return;
//     this.browserView = await createNewBrowserView(src);
//     return this;
//   }
...
const TabPrivate = {
 ...
 function createNewBrowserView(url){
    let newBrowserView =new BrowserView({
        webPreferences: {
